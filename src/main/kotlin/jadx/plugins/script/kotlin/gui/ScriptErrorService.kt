...
class ScriptErrorService(private val scriptArea: ScriptCodeArea) : AbstractParser() {
	...
	override fun parse(doc: RSyntaxDocument?, style: String?): ParseResult = result
	...
	companion object {
		...
		private fun convertLevel(severity: ScriptDiagnostic.Severity): ParserNotice.Level = when (severity) {
