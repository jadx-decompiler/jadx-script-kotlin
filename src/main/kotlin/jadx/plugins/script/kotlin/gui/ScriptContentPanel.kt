...
class ScriptContentPanel(
	...
	private val scriptArea: ScriptCodeArea = ScriptCodeArea(this, scriptData, scriptNode)
	...
	override fun getCodeArea(): AbstractCodeArea = scriptArea

	override fun getChildrenComponent(): Component = codeArea
