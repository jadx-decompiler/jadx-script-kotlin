...
private fun buildSimplePassInfo(jadx: JadxScriptInstance, name: String) = SimpleJadxPassInfo(buildScriptName(jadx, name))
...
) : ScriptOrderedPass(jadx, name, runAfter, runBefore),
	JadxPreparePass
