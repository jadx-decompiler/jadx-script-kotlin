...
class Gui(
	...
	fun registerGlobalKeyBinding(id: String, keyBinding: String, action: () -> Unit): Boolean = context().registerGlobalKeyBinding(id, keyBinding, action)
	...
	private fun context(): JadxGuiContext = guiContext ?: throw IllegalStateException("GUI plugins context not available!")
}
